...
if (isset($_GET["hapus"])) {
    ...
    header("Location: data-siswa.php?status=hapus");
    exit;
} 
                if(isset($_GET['edit'])){
                $id = $_GET['edit'];
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="aksi-siswa">
                            ...
                            <a href="?konfirmasi=<?php echo $data['id_user']; ?>"><button class="button-detail">Hapus</button></a>
